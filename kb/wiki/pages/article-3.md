...
- HAS_SUBUNIT: [[article-3.1]]
- DEFINES: [[def-ai-system]]
- DEFINES: [[def-risk]]
- DEFINES: [[def-provider]]
- DEFINES: [[def-deployer]]
- DEFINES: [[def-authorised-representative]]
- DEFINES: [[def-importer]]
- DEFINES: [[def-distributor]]
- DEFINES: [[def-operator]]
- DEFINES: [[def-placing-on-the-market]]
- DEFINES: [[def-making-available-on-the-market]]
- DEFINES: [[def-putting-into-service]]
- DEFINES: [[def-intended-purpose]]
- DEFINES: [[def-reasonably-foreseeable-misuse]]
- DEFINES: [[def-safety-component]]
- DEFINES: [[def-sme]]
- DEFINES: [[def-smc]]
- DEFINES: [[def-instructions-for-use]]
- DEFINES: [[def-recall-of-an-ai-system]]
- DEFINES: [[def-withdrawal-of-an-ai-system]]
- DEFINES: [[def-performance-of-an-ai-system]]
- DEFINES: [[def-notifying-authority]]
- DEFINES: [[def-conformity-assessment]]
- DEFINES: [[def-conformity-assessment-body]]
- DEFINES: [[def-notified-body]]
- DEFINES: [[def-substantial-modification]]
- DEFINES: [[def-ce-marking]]
- DEFINES: [[def-post-market-monitoring-system]]
- DEFINES: [[def-market-surveillance-authority]]
- DEFINES: [[def-harmonised-standard]]
- DEFINES: [[def-common-specification]]
- DEFINES: [[def-training-data]]
- DEFINES: [[def-validation-data]]
- DEFINES: [[def-validation-data-set]]
- DEFINES: [[def-testing-data]]
- DEFINES: [[def-input-data]]
- DEFINES: [[def-biometric-data]]
- DEFINES: [[def-biometric-identification]]
- DEFINES: [[def-biometric-verification]]
- DEFINES: [[def-special-categories-of-personal-data]]
- DEFINES: [[def-sensitive-operational-data]]
- DEFINES: [[def-emotion-recognition-system]]
- DEFINES: [[def-biometric-categorisation-system]]
- DEFINES: [[def-remote-biometric-identification-system]]
- DEFINES: [[def-real-time-remote-biometric-identification-system]]
- DEFINES: [[def-post-remote-biometric-identification-system]]
- DEFINES: [[def-publicly-accessible-space]]
- DEFINES: [[def-law-enforcement]]
- DEFINES: [[def-ai-office]]
- DEFINES: [[def-national-competent-authority]]
- DEFINES: [[def-serious-incident]]
- DEFINES: [[def-personal-data]]
- DEFINES: [[def-non-personal-data]]
- DEFINES: [[def-profiling]]
- DEFINES: [[def-real-world-testing-plan]]
- DEFINES: [[def-sandbox-plan]]
- DEFINES: [[def-ai-regulatory-sandbox]]
- DEFINES: [[def-ai-literacy]]
- DEFINES: [[def-testing-in-real-world-conditions]]
- DEFINES: [[def-informed-consent]]
- DEFINES: [[def-deep-fake]]
- DEFINES: [[def-widespread-infringement]]
- DEFINES: [[def-critical-infrastructure]]
- DEFINES: [[def-general-purpose-ai-model]]
- DEFINES: [[def-high-impact-capabilities]]
- DEFINES: [[def-systemic-risk]]
- DEFINES: [[def-general-purpose-ai-system]]
- DEFINES: [[def-floating-point-operation]]
- REFERENCES: [[article-2]]
- REFERENCES: [[article-2]]
- REFERENCES: [[article-2]]
- REFERENCES: [[article-9]]
- REFERENCES: [[article-10]]
- REFERENCES: [[article-10]]
...
- REFERENCES: [[article-2]]
- HAS_OBLIGATION: [[obligation-article-3-0]]
